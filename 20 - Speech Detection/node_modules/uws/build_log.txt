...
../src/addon.h:21:15: warning: 'MakeCallback' is deprecated: Use MakeCallback(..., async_context) [-Wdeprecated-declarations]
        node::MakeCallback(isolate, isolate->GetCurrentContext()->Global(), Local<Function>::New(isolate, noop), 0, nullptr);
              ^
/Users/thilolammers/.node-gyp/12.1.0/include/node/node.h:173:1: note: 'MakeCallback' has been explicitly marked deprecated here
NODE_DEPRECATED("Use MakeCallback(..., async_context)",
^
/Users/thilolammers/.node-gyp/12.1.0/include/node/node.h:93:20: note: expanded from macro 'NODE_DEPRECATED'
...
../src/addon.h:37:47: error: no matching constructor for initialization of 'String::Utf8Value'
            utf8Value = new (utf8ValueMemory) String::Utf8Value(value);
                                              ^                 ~~~~~
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8.h:3002:5: note: candidate constructor not viable: no known conversion from 'const Local<v8::Value>' to 'const v8::String::Utf8Value' for 1st argument
    Utf8Value(const Utf8Value&) = delete;
    ^
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8.h:2995:5: note: candidate constructor not viable: requires 2 arguments, but 1 was provided
...
../src/addon.h:79:83: error: too few arguments to function call, single argument 'context' was not specified
    uWS::Group<isServer> *group = hub.createGroup<isServer>(args[0]->IntegerValue(), args[1]->IntegerValue());
                                                            ~~~~~~~~~~~~~~~~~~~~~ ^
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8.h:2565:3: note: 'IntegerValue' declared here
  V8_WARN_UNUSED_RESULT Maybe<int64_t> IntegerValue(
  ^
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8config.h:347:31: note: expanded from macro 'V8_WARN_UNUSED_RESULT'
...
../src/addon.h:102:136: warning: 'NewFromUtf8' is deprecated: Use maybe version [-Wdeprecated-declarations]
    return opCode == uWS::OpCode::BINARY ? (Local<Value>) ArrayBuffer::New(isolate, (char *) message, length) : (Local<Value>) String::NewFromUtf8(isolate, message, String::kNormalString, length);
                                                                                                                                       ^
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8.h:2890:10: note: 'NewFromUtf8' has been explicitly marked deprecated here
  static V8_DEPRECATED(
         ^
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8config.h:307:29: note: expanded from macro 'V8_DEPRECATED'
...
../src/addon.h:223:51: error: no matching member function for call to 'ToObject'
        uv_fileno((handle = getTcpHandle(args[0]->ToObject()->GetAlignedPointerFromInternalField(0))), (uv_os_fd_t *) &ticket->fd);
                                         ~~~~~~~~~^~~~~~~~
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8.h:2532:44: note: candidate function not viable: requires single argument 'context', but no arguments were provided
  V8_WARN_UNUSED_RESULT MaybeLocal<Object> ToObject(
                                           ^
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8.h:2546:35: note: candidate function not viable: requires single argument 'isolate', but no arguments were provided
...
../src/addon.h:372:35: error: no matching member function for call to 'BooleanValue'
    uWS::OpCode opCode = args[2]->BooleanValue() ? uWS::OpCode::BINARY : uWS::OpCode::TEXT;
                         ~~~~~~~~~^~~~~~~~~~~~
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8.h:2559:8: note: candidate function not viable: requires single argument 'isolate', but no arguments were provided
  bool BooleanValue(Isolate* isolate) const;
       ^
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8.h:2562:51: note: candidate function not viable: requires single argument 'context', but no arguments were provided
...
../src/addon.h:403:40: error: too few arguments to function call, expected 4, have 3
        ...
        ~~~~~~~~                       ^
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8.h:4148:3: note: 'Call' declared here
...
../src/addon.h:462:17: warning: 'Set' is deprecated: Use maybe version [-Wdeprecated-declarations]
        object->Set(String::NewFromUtf8(isolate, "group"), group);
                ^
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8.h:3358:3: note: 'Set' has been explicitly marked deprecated here
  V8_DEPRECATE_SOON("Use maybe version",
  ^
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8config.h:322:29: note: expanded from macro 'V8_DEPRECATE_SOON'
  declarator __attribute__((deprecated(message)))
                            ^
...
../src/http.h:31:115: error: cannot initialize a parameter of type 'v8::NewStringType' with an rvalue of type 'v8::String::NewStringType'
                    args.GetReturnValue().Set(String::NewFromOneByte(args.GetIsolate(), (uint8_t *) header.value, String::kNormalString, header.valueLength));
                                                                                                                  ^~~~~~~~~~~~~~~~~~~~~
/Users/thilolammers/.node-gyp/12.1.0/include/node/v8.h:2905:64: note: passing argument to parameter 'type' here
...
gyp ERR! cwd /Users/thilolammers/code/JavaScript30/wesbos-JavaScript30-challange/20 - Speech Detection/node_modules/uws
